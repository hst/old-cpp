...
namespace hst
{
    ...
    public:
        ...
        <events_evaluator, map_t::const_iterator>
            events_iterator;
    ...
    typedef boost::shared_ptr<event_stateset_map_t>
        event_stateset_map_p;
    typedef boost::shared_ptr<const event_stateset_map_t>
        event_stateset_map_cp;
}
